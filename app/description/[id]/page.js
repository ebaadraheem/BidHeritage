  ...
  return (
        <div className='min-h-[100vh] bg-[#D2B48C] py-1'>
            <div className="max-w-4xl min-h-[100vh]  mx-auto p-6 flex flex-col  rounded-lg shadow-lg  ">
                ...
                <div>
                    {!auth.currentUser && <button onClick={() => document.getElementById('my_modal_3').showModal()} className="px-6 py-2 bg-[#CC5500] inline-block text-white font-semibold rounded-lg hover:bg-[#B64500] transition duration-200 mb-4">
                        Login to place bid
                    </button>}
